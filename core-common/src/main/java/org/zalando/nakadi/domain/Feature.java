...
public enum Feature {
    ...
    FORCE_EVENT_TYPE_UPDATE_SCHEMA_VALIDATION,
    LOLA_CONNECTIONS_ALLOWLIST,
    LIMIT_LOLA_CONNECTIONS,
    ASSERT_JSON_FORMAT_UUID,
    ASSERT_JSON_FORMAT_DATE,
    ASSERT_JSON_FORMAT_TIME,
    ASSERT_JSON_FORMAT_REGEX,
    ASSERT_JSON_FORMAT_ISO_3166_ALPHA_2,
    ASSERT_JSON_FORMAT_BCP47,
    ;
